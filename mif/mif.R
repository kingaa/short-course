...
#' ## Objectives
#' 
#' This tutorial is part of a series given as a [short course](http://kingaa.github.io/short-course) given at the [Summer Institute in Statistics and Modeling in Infectious Diseases](http://sismid.uw.org).
...
#' ## Introduction
#' 
#' Many, many statistical methods have been proposed for inference on POMP models [@he10,@King2016]. The volume of research indicates both the importance and the difficulty of the problem. Let's start by considering three criteria to categorize inference methods: the plug-and-play property; full-information or feature-based; frequentist or Bayesian.
#' 
