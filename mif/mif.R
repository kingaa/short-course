...
#' 
#' - Inference methodology that calls `rprocess` but not `dprocess` is said to be ___plug-and-play__.
...
#' - Two __non-plug-and-play__ methods (expectation-maximization (EM) algorithms and Markov chain Monte Carlo (MCMC)) have theoretical convergence problems for nonlinear POMP models.
