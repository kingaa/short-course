...
```{r ssdiag,echo=FALSE,purl=FALSE}
library(grid)
...
[Download a script containing the **R** commands below.](http://raw.githubusercontent.com/kingaa/short-course/gh-pages/pfilter/pfilter.R)
