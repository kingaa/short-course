...
html-docs: README.md index.html intro/intro.html stochsim/stochsim.html pfilter/pfilter.html mif/mif.html polio/polio.html measles/measles.html contacts/contacts.html ebola/ebola.html pfilter/monteCarlo.html measles/measles-profile.html prep/preparation.html 
	for i in $^; do cp $$i www/$$i; done

datafiles: ebola/ebola_data.csv intro/parus.csv contacts/contacts.csv contacts/contacts2.csv polio/polio_wisconsin.csv stochsim/bsflu_data.txt
	for i in $^; do cp $$i www/$$i; done
